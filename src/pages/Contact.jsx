...
const Contact = () => {
  return (
    <section className="py-16 bg-white font-sans px-6">
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col items-center">
          <div className="text-center mb-10 max-w-[600px] w-full">
            <h2 className="text-[32px] sm:text-[36px] md:text-[42px] font-medium text-black mb-10">
              Connect with Your Trusted Accounting Advisors
            </h2>
          </div>

          <div className="flex flex-col md:flex-row justify-between items-stretch gap-6 md:gap-10 w-full">
            <div className="w-full md:w-[360px] flex flex-col justify-between">
              <h4 className="text-[18px] sm:text-[19px] md:text-[20px] font-normal text-gray-800 w-full md:w-[260px] mb-5">
              ...
              <div className="flex flex-col gap-4 sm:gap-5">
                ...
                <div className="flex items-center justify-between bg-white p-4 border border-gray-200 rounded-md">
                  ...
                  <div className="flex-1 ml-4">
                    <h5 className="text-[14px] sm:text-[16px] font-medium text-black m-0">
                      Give us call
                    </h5>
                    <p className="text-[12px] sm:text-[14px] text-gray-600 m-0 mt-1">
                      (880) 18845612312
                    </p>
                  </div>
            ...
            <div className="flex-1 min-w-[340px] mt-6 md:mt-0">
              <form className="flex flex-col gap-3 sm:gap-4">
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    type="text"
                    placeholder="Enter your first name"
                    className="w-full sm:w-1/2 p-3 border border-gray-200 text-sm text-gray-800 outline-none placeholder-gray-500 rounded-md"
                  />
                  <input
                    type="text"
                    placeholder="Enter your last name"
                    className="w-full sm:w-1/2 p-3 border border-gray-200 rounded-md text-sm text-gray-800 outline-none placeholder-gray-500"
                  />
                </div>
                <input
                  type="email"
